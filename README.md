...
**Countries-App** A single page web application that allows users to see list of countries in the world, search countries by name or region and click of a country to see more information.
...
- **Look up a country by name or region**
...
- [Live Demo Link](https://countries-app-2.onrender.com)
...
- Thanks to Microverse for the the project insipiration and the learning resources
- Thanks to [Nelson Sakwa on Behance](https://www.behance.net/sakwadesignstudio) for the design inspiration
